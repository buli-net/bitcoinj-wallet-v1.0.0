 ...
 * Release documentation for the transaction history screen.
 * Loads transactions directly from the active bitcoinj wallet, derives sent and received values, applies the selected filter, and preserves the filter across Activity recreation.
        ...
        new Thread(() -> {
            ...
            try {
                ...
                for (Transaction transaction : transactions) {
                    ...
                    String type = net.isNegative() ? getString(R.string.transaction_sent) : getString(R.string.transaction_received);
                    ...
                    String confirmationText = getString(R.string.transaction_confirmations, depth);
                ...
                runOnUiThread(() -> {
                    ...
                    empty.setText(getString(R.string.unable_load_transactions, error.getMessage()));
