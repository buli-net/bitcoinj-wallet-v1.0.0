...
public class SentActivity extends AppCompatActivity {
    ...
    private void applyFilter(){
        ...
        tabAll.setTextColor(ThemeUtils.color(this, filter==0 ? android.R.attr.textColorPrimaryInverse : android.R.attr.textColorPrimary));
        tabSent.setTextColor(ThemeUtils.color(this, filter==1 ? android.R.attr.textColorPrimaryInverse : android.R.attr.textColorPrimary));
        tabReceived.setTextColor(ThemeUtils.color(this, filter==2 ? android.R.attr.textColorPrimaryInverse : android.R.attr.textColorPrimary));
        filtered.clear();
