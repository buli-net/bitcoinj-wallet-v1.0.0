...
public class MainActivity extends AppCompatActivity
    ...
    @ViewById protected Button btnActionScan_AM;
    @ViewById protected Button btnActionSend_AM;
    @ViewById protected Button btnActionBackup_AM;
    @ViewById protected Button btnActionRestore_AM;
    @ViewById protected Button btnActionInfo_AM;
    @ViewById protected Button btnTransactions_AM;
    @ViewById protected Button btnSettings_AM;
    ...
    protected void initUI() {
        ...
        btnActionScan_AM.setOnClickListener(v -> startActivity(new Intent(this, wallet.scan.ScanActivity.class)));
        btnActionSend_AM.setOnClickListener(v ->
                startActivity(new Intent(this, wallet.send.SendActivity.class)));
        btnActionBackup_AM.setOnClickListener(v -> startActivity(new Intent(this, wallet.backup.BackupActivity.class)));
        btnActionRestore_AM.setOnClickListener(v -> startActivity(new Intent(this, wallet.backup.RestoreActivity.class)));
        btnActionInfo_AM.setOnClickListener(v -> startActivity(new Intent(this, wallet.about.AboutActivity.class)));
        btnTransactions_AM.setOnClickListener(v ->
                startActivity(new Intent(this, wallet.history.SentActivity.class)));
        btnSettings_AM.setOnClickListener(v -> showAbout());
    ...
    @Override @UiThread public void displayTransactionHistory(String history) {
        ...
        if (TextUtils.isEmpty(history) || history.startsWith("No transactions")) {
            ...
            empty.setTextColor(ThemeUtils.color(this, android.R.attr.textColorSecondary));
        ...
        for (int i = 0; i < count; i++) {
            ...
            row.setTextSize(13);
            row.setTextColor(ThemeUtils.color(this, android.R.attr.textColorPrimary));
            row.setPadding(0, 10, 0, 10);
            llRecentTransactions_AM.addView(row);
            if (i + 1 < count) {
                View line = new View(this);
                line.setBackgroundColor(ThemeUtils.color(this, android.R.attr.textColorSecondary));
