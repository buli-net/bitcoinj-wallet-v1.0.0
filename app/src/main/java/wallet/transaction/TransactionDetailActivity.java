        ...
        new Thread(() -> {
            try {
                ...
                synchronized (wallet) {
                    ...
                    Transaction replacement = new Transaction(
                            parameters, original.bitcoinSerialize());
                    replacement.setVersion(Math.max(2, original.getVersion()));
                    for (int i = 0; i < replacement.getInputs().size(); i++) {
                        TransactionInput oldInput = original.getInput(i);
                        ...
                        replacement.replaceInput(i, replacementInput);
                    }
                    ...
                    replacementChange.setValue(replacementValue);
