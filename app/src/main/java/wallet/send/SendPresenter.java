...
public final class SendPresenter {
    ...
    private static String shortenRecipientForDisplay(String address) {
        final int keepStart = 12;
        final int keepEnd = 10;
        ...
        int maxLength = keepStart + markerLength + keepEnd;
        ...
        new Thread(() -> {
            ...
            try {
                ...
                confirmationItems.add(new ConfirmationDisplayItem(
                        ...
                        shortenRecipientForDisplay(recipient),
                        "",
                        false,
                        false,
