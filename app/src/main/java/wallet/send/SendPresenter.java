    ...
    public void send() {
        ...
        new Thread(() -> {
            ...
            try {
                ...
                details.append(view.getStringResource(
                                R.string.details_recipient,
                                recipient))
                        .append(view.getStringResource(
                ...
                if (feeWarning) {
                    details.append(view.getStringResource(R.string.details_fee_note));
                }

                if (remaining.isZero()) {
                    details.append(view.getStringResource(R.string.details_full_balance));
                }
