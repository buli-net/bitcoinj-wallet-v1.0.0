 ...
 * Displays the active receive address and QR code, accepts a recipient and amount, exposes the fee-rate selector, and delegates transaction preparation and broadcast to SendPresenter.
