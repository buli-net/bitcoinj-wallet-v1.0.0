 ...
 * Accepts a recipient and amount and exposes the fee-rate selector.
 * Delegates transaction preparation and direct broadcast to SendPresenter.
 * All user-visible text is resolved from Android string resources.
 */
