...
public final class WalletToolsActivity extends AppCompatActivity {
    ...
    private void refreshWatchedAddresses() {
        ...
        NetworkParameters parameters = getParameters();
        // Use Wallet.getUnspents() as the source of truth for current UTXOs.
        // It includes outputs marked mine OR watched by bitcoinj. We then filter strictly
        // by the watched script, so the normal wallet balance and watch-only balances stay separate.
